...
// src/is/bn.ts
function isBn(value) {
  return BN__default.default.isBN(value);
}
...
function u8aToBn(value, { isLe = true, isNegative = false } = {}) {
  ...
  if (isNegative && count && value[count - 1] & 128) {
    switch (count) {
      ...
      case 1:
        return new BN__default.default((value[0] ^ 255) * -1 - 1);
      case 2:
        return new BN__default.default((value[0] + (value[1] << 8) ^ 65535) * -1 - 1);
      case 3:
        return new BN__default.default((value[0] + (value[1] << 8) + (value[2] << 16) ^ 16777215) * -1 - 1);
      case 4:
        return new BN__default.default((value[0] + (value[1] << 8) + (value[2] << 16) + value[3] * 16777216 ^ 4294967295) * -1 - 1);
      case 5:
        return new BN__default.default(((value[0] + (value[1] << 8) + (value[2] << 16) + value[3] * 16777216 ^ 4294967295) + (value[4] ^ 255) * 4294967296) * -1 - 1);
      case 6:
        return new BN__default.default(((value[0] + (value[1] << 8) + (value[2] << 16) + value[3] * 16777216 ^ 4294967295) + (value[4] + (value[5] << 8) ^ 65535) * 4294967296) * -1 - 1);
      default:
        return new BN__default.default(value, "le").fromTwos(count * 8);
    }
  }
  switch (count) {
    case 0:
      return new BN__default.default(0);
    case 1:
      return new BN__default.default(value[0]);
    case 2:
      return new BN__default.default(value[0] + (value[1] << 8));
    case 3:
      return new BN__default.default(value[0] + (value[1] << 8) + (value[2] << 16));
    case 4:
      return new BN__default.default(value[0] + (value[1] << 8) + (value[2] << 16) + value[3] * 16777216);
    case 5:
      return new BN__default.default(value[0] + (value[1] << 8) + (value[2] << 16) + (value[3] + (value[4] << 8)) * 16777216);
    case 6:
      return new BN__default.default(value[0] + (value[1] << 8) + (value[2] << 16) + (value[3] + (value[4] << 8) + (value[5] << 16)) * 16777216);
    default:
      return new BN__default.default(value, "le");
  }
}
...
function toBase58(value) {
  return base.base58.encode(u8aToU8a(value));
}
...
function hexToBn(value, { isLe = false, isNegative = false } = {}) {
  ...
  const stripped = hexStripPrefix(value);
  const bn = new BN__default.default(stripped, 16, isLe ? "le" : "be");
...
function bnToBn(value) {
  return value ? BN__default.default.isBN(value) ? value : isHex(value) ? hexToBn(value.toString()) : isBigInt(value) ? new BN__default.default(value.toString()) : isToBn(value) ? value.toBn() : isToBigInt(value) ? new BN__default.default(value.toBigInt().toString()) : new BN__default.default(value) : new BN__default.default(0);
}
...
// src/bn/consts.ts
var BN_ZERO = /* @__PURE__ */ new BN__default.default(0);
var BN_ONE = /* @__PURE__ */ new BN__default.default(1);
var BN_TWO = /* @__PURE__ */ new BN__default.default(2);
var BN_THREE = /* @__PURE__ */ new BN__default.default(3);
var BN_FOUR = /* @__PURE__ */ new BN__default.default(4);
var BN_FIVE = /* @__PURE__ */ new BN__default.default(5);
var BN_SIX = /* @__PURE__ */ new BN__default.default(6);
var BN_SEVEN = /* @__PURE__ */ new BN__default.default(7);
var BN_EIGHT = /* @__PURE__ */ new BN__default.default(8);
var BN_NINE = /* @__PURE__ */ new BN__default.default(9);
var BN_TEN = /* @__PURE__ */ new BN__default.default(10);
var BN_HUNDRED = /* @__PURE__ */ new BN__default.default(100);
var BN_THOUSAND = /* @__PURE__ */ new BN__default.default(1e3);
var BN_MILLION = /* @__PURE__ */ new BN__default.default(1e6);
var BN_BILLION = /* @__PURE__ */ new BN__default.default(1e9);
var BN_QUINTILL = BN_BILLION.mul(BN_BILLION);
var BN_MAX_INTEGER = /* @__PURE__ */ new BN__default.default(Number.MAX_SAFE_INTEGER);
var BN_SQRT_MAX_INTEGER = /* @__PURE__ */ new BN__default.default(94906265);
...
var MAX_U8 = BN_TWO.pow(new BN__default.default(8 - 2)).isub(BN_ONE);
var MAX_U16 = BN_TWO.pow(new BN__default.default(16 - 2)).isub(BN_ONE);
var MAX_U32 = BN_TWO.pow(new BN__default.default(32 - 2)).isub(BN_ONE);
...
function compactFromU8a(input) {
  ...
  switch (u8a[0] & 3) {
    case 0:
      return [1, new BN__default.default(u8a[0] >>> 2)];
    case 1:
      return [2, new BN__default.default(u8a[0] + (u8a[1] << 8) >>> 2)];
    case 2:
      return [4, new BN__default.default(u8a[0] + (u8a[1] << 8) + (u8a[2] << 16) + u8a[3] * 16777216 >>> 2)];
    // 0b11
    default: {
      ...
      switch (offset) {
        ...
        case 5:
          return [5, new BN__default.default(u8a[1] + (u8a[2] << 8) + (u8a[3] << 16) + u8a[4] * 16777216)];
        case 6:
          return [6, new BN__default.default(u8a[1] + (u8a[2] << 8) + (u8a[3] << 16) + (u8a[4] + (u8a[5] << 8)) * 16777216)];
        // 6 bytes data is the maximum, 48 bits (56 would overflow)
        case 7:
          return [7, new BN__default.default(u8a[1] + (u8a[2] << 8) + (u8a[3] << 16) + (u8a[4] + (u8a[5] << 8) + (u8a[6] << 16)) * 16777216)];
...
function toBase64(value) {
  return base.base64.encode(u8aToU8a(value));
}
...
exports.base58ToU8a = base58ToU8a;
exports.base64 = base64_exports;
exports.base64ToU8a = base64ToU8a;
exports.bigint = bigint_exports;
exports.bn = bn_exports;
exports.buffer = buffer_exports;
exports.compact = compact_exports;
exports.float = float_exports;
exports.has = has_exports;
exports.hex = hex_exports;
exports.is = is_exports;
exports.number = number_exports;
exports.string = string_exports;
exports.types = types_exports;
exports.u8a = u8a_exports;
exports.u8aToBase58 = u8aToBase58;
exports.u8aToBase64 = u8aToBase64;
